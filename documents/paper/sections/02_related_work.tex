...
\hline
\multicolumn{3}{l}{$^{\mathrm{a}}$Compiled from \cite{erdas2024} and \cite{jibon2025}.}
\end{tabular}
\end{center}
\end{table}
...
On the other hand, DeiT (Data-efficient Image Transformer) was proposed in \cite{touvron2021} as an extension of the original Vision Transformer architecture \cite{dosovitskiy2021}. DeiT introduces a knowledge distillation strategy that enables transformer models to be trained effectively on relatively smaller datasets while maintaining competitive performance.
